			...
			<table class="form-table" role="presentation">
				<tr>
					...
					<td>
						...
						<label><input type="checkbox" name="<?php echo esc_attr( $name( 'track_presence' ) ); ?>" value="1" <?php echo $checked( 'track_presence' ); ?>> <?php esc_html_e( 'Admin “who’s on the site now” (uses one extra request per admin page view — off by default)', 'acps-site-toolkit' ); ?></label>

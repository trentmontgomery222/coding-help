			...
			<table class="form-table" role="presentation">
				<tr>
					...
					<td>
						...
						<label><input type="checkbox" name="<?php echo esc_attr( $name( 'track_visitors' ) ); ?>" value="1" <?php echo $checked( 'track_visitors' ); ?>> <?php esc_html_e( 'Unique users (by anonymised IP + browser, like the spam filter — clearing cookies/cache can’t create a new one)', 'acps-site-toolkit' ); ?></label>
